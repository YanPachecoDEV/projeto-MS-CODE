...
function getInfoBasedOnScore(){
    if(totalScore() <= 6){
        var score_info = "A Móveis Simonetti lamenta, e irá trabalhar para melhorar sua exepriência como cliente!";
    } else if(totalScore() >= 7){
        var score_info = "A Móveis Simonetti fica feliz em ter você como cliente!"
    }
